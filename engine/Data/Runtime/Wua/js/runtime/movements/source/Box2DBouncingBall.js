...
CRunMvtbox2dbouncingball.prototype = {
    ...
    GetBase: function () {
        //this locates the physics engine object
        var pOL = 0;
        var nObjects = 0;
    ...
    move: function () {
        //this is where the movement updates
...
CServices.extend(CRunMBase, CRunMvtbox2dbouncingball);