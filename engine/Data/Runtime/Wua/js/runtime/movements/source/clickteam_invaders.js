...
function CRunMvtclickteam_invaders() {
    //call chain
    CRunMvtExtension.call(this);

    //call self
}

CRunMvtclickteam_invaders.prototype = {
                        ...
                        if (data.frames % data.speed == 0) {
                            ...
                            for (index = 0; index < data.myList.size(); index++) {
                                ...
                                if (data.cdy != 0) {
                                    ...
                                    hoPtr.rom.rmMovement.newMake_Move(hoPtr.roc.rcSpeed, hoPtr.hoAdRunHeader.getDir(hoPtr));
                                    //this.moveIt();
                                }
                                else {
...
CServices.extend(CRunMvtExtension, CRunMvtclickteam_invaders);
