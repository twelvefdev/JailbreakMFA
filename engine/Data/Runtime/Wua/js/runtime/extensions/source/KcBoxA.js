...
CRunKcBoxA.prototype = {
    ...
    displayRunObject: function (context, xDraw, yDraw) {
        ...
        var rc = new CRect();
        rc.left = this.ho.hoX - this.rh.rhWindowX + xDraw + this.ho.pLayer.x;
        rc.top = this.ho.hoY - this.rh.rhWindowY + yDraw + this.ho.pLayer.y;
                ...
                if (bDisplayImage == true) {
                    ...
                    if (wc > 0 && hc > 0) {
                        if ((this.rData_dwFlags & CRunKcBoxA.ALIGN_IMAGE_PATTERN) != 0) {
                            ...
                            context.renderImage(this.rData_wImage, xc, yc, 0, 1, 1, 0, 0, this);
                        }
                    }
    ...
    drawText: function (context, text, textLocation, font, flags, hyperlink, clr) {
        if (this.displayText) {
            ...
            } else if ((this.rData_dwFlags & CRunKcBoxA.ALIGN_RIGHT) != 0) {
...
CServices.extend(CRunExtension, CRunKcBoxA);
