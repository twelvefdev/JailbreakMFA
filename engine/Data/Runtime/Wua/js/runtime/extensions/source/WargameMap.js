...
CRunWargameMap.prototype = {
        ...
        WithinBounds: function (x, y) { //1-based
            if ((x > 0) && (x <= this.mapWidth) && (y > 0) && (y <= this.mapHeight)) {
                return true;
            }
            return false;
        },
        PointWithinBounds: function (x) { //1-based
            if (this.path == null) {
                return false;
            }
        ...
        condition: function (num, cnd) {
            switch (num) {
                ...
                case CRunWargameMap.CND_ENDOFPATH:
...
CServices.extend(CRunExtension, CRunWargameMap);
