...
CRunGraphicFont.prototype = {
        ...
        createFont: function () {
            ...
            if (image.mosaicId == 0) {
                ...
                context.drawImage(this.rh.rhApp.imageBank.mosaics[image.mosaicId].image.img, image.mosaicX, image.mosaicY, width, height, 0, 0, width, height);
            }
...
CServices.extend(CRunExtension, CRunGraphicFont);