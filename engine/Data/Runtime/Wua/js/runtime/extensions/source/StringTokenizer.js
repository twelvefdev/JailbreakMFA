...
CRunStringTokenizer.prototype = {
    ...
    act0_Splitstring0withdelimiters11D: function (act) {
        ...
        this.Tokens.clear();
        var Tokenizer = new CTokeniser(param0, param1);
    ...
    act1_Splitstring0withdelimiters1and22D: function (act) {
        ...
        this.Tokens2D.clear();
        var XTokenizer = new CTokeniser(param0, param1);
        var XTokenCount = XTokenizer.countTokens();
        var x;
        for (x = 0; x < XTokenCount; x++) {
            var New = new CArrayList();
            var YTokenizer = new CTokeniser(XTokenizer.nextToken(), param2);
...
CServices.extend(CRunExtension, CRunStringTokenizer);