...
CRunGet.prototype = {
            ...
            switch (num) {
                case 0: /* Request URL */
                    ...
                    if (data.length) {
                        ...
                        // this must be filled according your setting in server and your changes in headers
                        ...
                        request.onreadystatechange = function () {
                            ...
                            if (request.readyState == 4) {
                                ...
                                that.pending = false;
                                that.respStatus = request.status;
        ...
        fillheaders: function (request) {
            ...
            request.setRequestHeader('accept-charset', charset);
        ...
        ReverseCarSet: function (uCodePage) {
            var sCharSet;
...
CServices.extend(CRunExtension, CRunGet);