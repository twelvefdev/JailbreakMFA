...
CRunkclist.prototype = {
    ...
    createRunObject: function (file, cob, version) {
        ...
        //get font info
        this.listFontInfo = this.ho.hoAdRunHeader.rhApp.unicode ? file.readLogFont() : file.readLogFont16();
        ...
        try {
            switch (num) {
                ...
                case 4: /* Save list */
                    ...
                    this.rh.rhApp.saveFile(name, this.implodeRows("\n"));
                    break;
                ...
                case 7: /* Insert line */
                    ...
                    //can we shortcut the insert procedure to an add instead?
...
CServices.extend(CRunControl, CRunkclist);