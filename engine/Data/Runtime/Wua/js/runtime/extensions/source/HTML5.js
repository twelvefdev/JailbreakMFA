...
CRunHTML5.prototype = {
        ...
        actSaveCookie: function (act) {
            ...
            expires.setTime(expires.now() + (1000 * 60 * 60 * 24 * days));
        ...
        actCallFunction: function (act) {
            ...
            if (typeof window[func] != 'function') {
                ...
                try {
                    this.ret = window[func](this.parameters[0], this.parameters[1], this.parameters[2], this.parameters[3], this.parameters[4], this.parameters[5], this.parameters[6], this.parameters[7], this.parameters[8], this.parameters[9], this.parameters[10]);
                }
                catch (e) {
                    this.bError = true;
                    this.onErrorCount = this.ho.getEventCount();
        ...
        expression: function (num) {
            switch (num) {
                ...
                case CRunHTML5.EXP_BROWSEROS:
                    if (Runtime.name == "UWP") {
                        if (Runtime.deviceType == CRuntime.DEVICE_DESKTOP || Runtime.deviceType == CRuntime.DEVICE_TABLET)
                            return "Windows.Desktop";
                        else if (Runtime.deviceType == CRuntime.DEVICE_PHONE)
                            return "Windows.Mobile";
                        else if (Runtime.deviceType == CRuntime.DEVICE_CONSOLE)
                            return "Windows.Xbox";
                    }
        ...
        expTotal: function () {
            if (this.rh.rhApp.parentApp != null) {
                return this.rh.rhApp.parentApp.loadingDataTotal;
            }
            return 0;
        },
        expLoaded: function () {
            if (this.rh.rhApp.parentApp != null) {
                return this.rh.rhApp.parentApp.loadingDataCurrent;
            }
            return 0;
        },
        expPercent: function () {
            if (this.rh.rhApp.parentApp != null) {
                if (this.rh.rhApp.parentApp.loadingDataTotal != 0) {
                    return (this.rh.rhApp.parentApp.loadingDataCurrent * 100) / this.rh.rhApp.parentApp.loadingDataTotal;
                }
            }
            return 0;
        },
...
CServices.extend(CRunExtension, CRunHTML5);