...
CRunActiveBackdrop.prototype = {
    ...
    displayRunObject: function (context, xDraw, yDraw) {
        if (this.currentImage >= 0) {
            ...
            context.renderImage(image, x + image.xSpot, y + image.ySpot, 0, 1.0, 1.0, 0, 0, this);
        }
    },
    ...
    actSetY: function (act) {
        this.ho.hoY = act.getParamExpression(this.rh, 0);
    },
...
CServices.extend(CRunExtension, CRunActiveBackdrop);