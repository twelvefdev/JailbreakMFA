...
CRunkcdirect.prototype = {
        ...
        TurnToDirection: function (dir, object) {
            ...
            direction = this.rh.getDir(object);
            goal_angle = dir;
        ...
        AddDir_act: function (speed, object) {
            ...
            direction1 = this.rh.getDir(object);
...
CServices.extend(CRunExtension, CRunkcdirect);