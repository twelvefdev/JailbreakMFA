        ...
        switch (this.type) {
            case CRunKcButton.BTNTYPE_RADIOBTN:
                ...
                for (var i = 0; i < this.options.length; ++i) {
                    ...
                    option.inputElement.checked = false;
    ...
    action: function (num, act) {
        switch (num) {
            ...
            case 11: /* Select radio button */
                ...
                //}
                var updateIndex;
                for (updateIndex = 0; updateIndex < this.options.length; updateIndex++) {
                    this.options[updateIndex].inputElement.checked = (updateIndex == index);
                    if (index < 0) {
                        this.options[updateIndex].inputElement.checked = false;
                    }
                }
