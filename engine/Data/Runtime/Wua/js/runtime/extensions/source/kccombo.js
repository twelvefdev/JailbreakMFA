...
CRunkccombo.prototype = {
        ...
        createRunObject: function (file, cob, version) {
            ...
            e.className = 'fusionRunControlKcCombo';

            //apply theme
            Runtime.onThemeElement(e, CRuntime.THEME_ELEMENT_COMBO);
            ...
            try {
                switch (num) {
                    ...
                    case 4: /* Save list */
                        ...
                        var text = "";
                        for (n = 0; n < length; n++) {
                            text += this.element.options[n].text + "\n";
                        }
...
CServices.extend(CRunControl, CRunkccombo);