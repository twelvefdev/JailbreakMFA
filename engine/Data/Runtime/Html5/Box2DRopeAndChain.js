...
CRunBox2DRopeAndChain.prototype = CServices.extend(new CRunExtension(),
	{
		GetBase: function ()
		{
			var pOL = 0;
		...
		destroyRunObject: function ()
		{
			...
			{
				if(typeof(this.bodystart) != 'undefined')
					this.bodystart.destroy(base);
				if(typeof(this.bodyend) != 'undefined')
					this.bodyend.destroy(base);
			}
			return 0;
		},
...
// ELEMENT OBJECT
////////////////////////////////////////////////////////////////////////
function CElement(parent, image, number)
{
...
CElement.prototype = CServices.extend(new CRunMBase(),
	{
		...
		setPosition: function (x, y, angle)
		{
			...
			if (this.nLayer != this.parent.ho.ros.rsLayer) {
			    ...
			    this.pLayer = this.parent.rh.rhFrame.layers[this.nLayer];
			    this.pLayer.planeSprites.addChild(this);
			}
		},
		draw:        function (context, xx, yy)
		{
			...
			{
				var image = this.parent.rh.rhApp.imageBank.getImageFromHandle(this.image);
				if (image)
				{
