...
CRunScreenZoom.prototype = CServices.extend(new CRunExtension(),
	{
		...
		createRunObject: function (file, cob, version)
		{
			...
			if (this.rh.rhApp.scScaleX != 1 || this.rh.rhApp.scScaleY != 1)
				bZoom = true;
			this.rh.rhApp.scScale = (this.rh.rhApp.scScaleX + this.rh.rhApp.scScaleY) / 2;
			file.skipBytes(8);
...
CSZLinear.prototype =
{
	...
	{
		var d = new Date();
		var delta = d.getTime() - this.initialTime;
...
CSZShake.prototype =
{
	animate: function ()
	{
		...
		if (d.getTime() > this.initialTime + this.total)
		{
			this.completed = true;
