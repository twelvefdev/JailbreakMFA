...
CRunGoogleMaps.prototype = CServices.extend(new CRunExtension(),
	{
		...
		{
			var mapOptions = {draggable: true, zoom: 8, panControl: true, zoomControl: false, scaleControl: true, center: new google.maps.LatLng(-34.397, 150.644), mapTypeId: google.maps.MapTypeId.ROADMAP};
		...
		act23_AddInfoWindowOverlay0123: function (param0, param1, param2, param3)
		{
			if (this.map != null)
			{
				this.map.openInfoWindow(new LatLng(param0, param1), new InfoWindowOptions({title: param2, content: param3}));
			}
		},
