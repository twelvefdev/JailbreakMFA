		...
		animate:      function ()
		{
			...
			else
			{
				if (width != this.oldWidth || height != this.oldHeight)
				{
					...
					this.fixture = this.parent.base.rBodyCreateCircleFixture(this.m_body, this, this.x, this.y, (width + height) / 4, this.parent.density, this.parent.friction, this.parent.restitution);
				}
			}
